...
;(function($) {
	...
	$.slidebars = function(options) {
   	...
   	$('.newPosts').on('touchend click', function(event) {
			eventHandler(event, $(this)); // Handle the event.
			Router.go('/new'); 
		});
   	$('.bestPosts').on('touchend click', function(event) {
			eventHandler(event, $(this)); // Handle the event.
			Router.go('/best'); 
		});
   	$('.pastWords').on('touchend click', function(event) {
			eventHandler(event, $(this)); // Handle the event.
			Router.go('/pastwords'); 
		});    
   	$('.myBestPosts').on('touchend click', function(event) {
			eventHandler(event, $(this)); // Handle the event.
			Router.go('/mybest');
		});
